...
def banner():
	...
	{re}╚═╝{cy}└─┘ ┴ └─┘┴
	           ...
	           Version : 1.01
	{re}Subscribe lallantop's channel 
	{cy}https://youtube.com/channel/UCagxVXpjpvgccY7JObHuUzA
	""")
banner()
...
print(gr+"[+] https://github.com/satyanandatripathi/TeleGram-Scraper-Adder/blob/master/README.md")
