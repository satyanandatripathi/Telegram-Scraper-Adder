...
print (cy+"Make sure to join our Telegram channel")
print (cy+"https://t.me/joinchat/OxmYRwSJN9ozMGY1")
...
print ("6. stay connected with satyanand TRiPATHi for more like this credit goes to termux professor.")
